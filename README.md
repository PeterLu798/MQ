...
* [13. Java中的锁以及如何选择适用于自己的锁](#13)
14. 数据压缩：时间换空间的游戏
15. 源码分析：RocketMQ是如何发消息的
...
现在的Socket接口中，底层的API已经将二进制转换成了字节，8个二进制代表1个字节，所以实际编程中的序列化和反序列化就是将字节数组和对象之间的相互转换。
...
<h3 id="13">13. Java中的锁以及如何选择适用于自己的锁</h3>
<br>&emsp;
<br>&emsp;
<br>&emsp;
<br>&emsp;
